...
<div id="contents"> 
    <div style="display: flex; justify-content: space-between; align-items:center;">
        <div>
            <font size=4>B.Sc. Mechatronics Engineering</font>
            <br>
            <font size=4>M.Sc. Robotics Engineering (Not finished yet)</font>
            <br>
            <font size=4>Front End Web Developer</font>
            <br>
            <font size=4>Passionate about Full Stack Blockchain Development...</font>
            <br>
        </div>
    <div>
...
<h2 align="center" style="color: #A383F7; font-size:1.8rem; font-weight:300">⚒️ Languages-Frameworks-Tools ⚒️</h2>
<div align="center" >
    <img src="https://skillicons.dev/icons?i=py,js,html,css,sass,solidity,swift,cpp,bash&perline=9" />
    <br>
    <br>
    <img src="https://skillicons.dev/icons?i=react,nextjs,tailwind,bootstrap,redux,express,mongodb,nodejs,firebase,apollo&perline=5" />
    <br>
    <br>
    <img src="https://skillicons.dev/icons?i=github,git,figma,remix,graphql,ipfs,postman,autocad&perline=8" />
</div>
